...
const stockfish_bundle_1 = require("./stockfish-bundle");
__exportStar(require("chess.js"), exports);
class ChessEngine extends chess_js_1.Chess {
    constructor() {
        super();
        this.evaluation = 0;
        ...
        return new Promise((resolve, reject) => {
            ...
            if (options.stockfishUrl) {
                ...
                const stockfishCode = wasmSupported
                    ? (0, stockfish_bundle_1.getStockfishWasmJs)()
                    : (0, stockfish_bundle_1.getStockfishJs)();
