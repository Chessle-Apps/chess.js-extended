...
describe("ChessEngine", () => {
  ...
  it("should correctly sequence UCI commands and resolve on bestmove", async () => {
    ...
    simulateWorkerMessage(
      "info depth 15 seldepth 22 multipv 1 score cp 13 nodes 48622 nps 151943 hashfull 999 tbhits 0 time 32 pv e2e4 e7e5 g1f3",
    );
  ...
  it("should handle Multi-PV analysis", async () => {
    ...
    simulateWorkerMessage(
      "info depth 15 seldepth 22 multipv 1 score cp 13 pv e2e4 e7e5",
    );
    simulateWorkerMessage(
      "info depth 15 seldepth 22 multipv 2 score cp 20 pv d2d4 d7d5",
    );
    simulateWorkerMessage(
      "info depth 15 seldepth 22 multipv 3 score cp 25 pv c2c4 c7c5",
    );
    simulateWorkerMessage("bestmove e2e4 ponder e7e5");
